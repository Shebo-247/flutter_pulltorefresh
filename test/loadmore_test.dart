...
//    expect(_refreshController.footerStatus, LoadStatus.idle);
  ...
  // # 157
  testWidgets("in Android,when viewport not full,it shouldn't make footer out of bottom edge,when enablePullUp = false || hideNotfull || state == nomore", (tester) async {
    RefreshController _refreshController = RefreshController();
    await tester.pumpWidget(Directionality(
      textDirection: TextDirection.ltr,
      child: SmartRefresher(
